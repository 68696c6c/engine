...
import (
	...
	"github.com/68696c6c/engine/audio/vorbis"
	"github.com/68696c6c/engine/camera"
	"github.com/68696c6c/engine/camera/control"
	...
	"github.com/68696c6c/engine/renderer"
...
type Options struct {
	...
	BackgroundColor string // Default scene background color name (see math32/color.go, mapColorNames variable for options)
}
...
func Create(ops Options) (*Application, error) {
	...
	*app.targetFPS = 60
	...
	// Clears the screen
	color := "gray"
	_, bgColorIsValid := math32.IsColorName(ops.BackgroundColor)
	if bgColorIsValid {
		color = ops.BackgroundColor
	}
	cc := math32.NewColor(color)
